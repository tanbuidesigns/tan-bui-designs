...
export default async function ControlRoomHistoryPage({ searchParams }: { searchParams: Promise<{ cursor?: string; state?: string }> }) {
  ...
  return (
    <ControlRoomShell activeSection="history" eyebrow="TBD Control Room · History" title="Persistent measurement history" description="Manual, idempotent captures with bounded evidence and explicit status. Stage A remains unbound until the storage gate is approved." baselineReviewDate="18 July 2026" lastUpdatedDate="18 July 2026">
