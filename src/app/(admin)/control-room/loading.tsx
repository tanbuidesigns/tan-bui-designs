...
export default function ControlRoomLoading() {
  return (
    <ControlRoomShell activeSection="overview" eyebrow="TBD Control Room · Loading" title="Preparing the Control Room" description="Server-side baseline and integration status are being assembled." baselineReviewDate="30 July 2026" lastUpdatedDate="30 July 2026">
